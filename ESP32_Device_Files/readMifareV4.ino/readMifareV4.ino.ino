//Version 4 of hjas2 IoT Toybox project
...
int MAX_SIZE = 1000;
int current_size = 0;
String toyTags[1000][3]; //Store tags in 2d array in format - {toybox scanner UUID; toytagID; timestamp}
...
void processTag(uint8_t aTag[]){
  ...
  **/
  ...
  if (tempIndex >= 0 && current_size > 0){
    ...
    toyTags[tempIndex][2] = "";
    current_size--;
    Serial.println("Toy removed from list");
  }
    ...
    current_size++;   
    Serial.println("Toy added to list: ");    
